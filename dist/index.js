...
export default function register(api) {
    ...
    api.registerTool({
        ...
        async execute(_id, params) {
            ...
            const explicitName = typeof params.notebook_name === "string"
    ...
    const toolDefs = [
        ...
        },
        {
            ...
            title: (params) => `Connect to Jupyter: ${String(params.jupyter_url ?? "")}`,
        },
        {
        ...
        },
        {
            ...
            title: (params) => `Restart notebook: ${String(params.notebook_name ?? "")}`,
        },
        {
            ...
            title: (params) => `Restart notebook: ${String(params.notebook_name ?? params.notebook_path ?? "")}`,
        },
        {
            ...
            title: (params) => `Unuse notebook: ${String(params.notebook_name ?? "")}`,
        },
        {
            ...
            title: (params) => `Unuse notebook: ${String(params.notebook_name ?? params.notebook_path ?? "")}`,
        },
        {
            ...
            title: (params) => `Read notebook: ${String(params.notebook_name ?? "")}`,
        },
        {
            ...
            title: (params) => `Read notebook: ${String(params.notebook_name ?? params.notebook_path ?? "")}`,
        },
        {
        ...
        },
        {
            ...
            title: (params) => `Insert + execute code cell at ${String(params.cell_index ?? "")}`,
        },
        {
