...
export default function register(api) {
    ...
    api.registerTool({
        ...
        description: "Return the Jupyter server URL and token that ClawPyter is currently connected to. Use this to verify the active connection after calling jupyter_connect_to_jupyter, or to construct notebook access URLs.",
        parameters: Type.Object({}),
        async execute(_id, params) {
